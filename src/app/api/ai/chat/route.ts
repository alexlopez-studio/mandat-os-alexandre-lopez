    ...
    const messages: AiConversationMessage[] = [
      {
        ...
        content: [
          ...
          '',
          'Tu disposes d’outils connectés en direct sur son compte Google : documents Drive, messagerie Gmail, et son Agenda.',
          ...
          '',
          'AGENDA GOOGLE :',
          'Tu as un accès complet en lecture et écriture sur l’agenda Google d’Alexandre :',
          '- Pour consulter les disponibilités ou RDV : utilise `google_agenda`.',
          '- Pour ajouter, planifier une visite, une estimation ou un rappel : utilise directement `google_agenda_creer_evenement`.',
          '- Pour modifier, décaler ou déplacer un événement : cherche d’abord son `event_id` avec `google_agenda` puis utilise `google_agenda_modifier_evenement`.',
          '- Pour supprimer ou annuler un événement : cherche son `event_id` avec `google_agenda` puis utilise `google_agenda_supprimer_evenement`.',
          '',
          'Réponds en français, de façon claire, chaleureuse et orientée prochaine action.',
