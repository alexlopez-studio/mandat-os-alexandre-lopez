      ...
      <CardContent className="flex flex-col gap-2 p-2">
        <div className="flex items-start justify-between">
          <div className="flex min-w-0 items-center gap-2 text-sm font-medium">
            <KindIcon
              className={cn('size-3.5 shrink-0', isVente ? 'text-primary' : 'text-emerald-500')}
              aria-hidden="true"
            />
            {/* La carte est le cas ou le titre est seul : la reference leve
                l'ambiguite entre deux dossiers de meme nom et meme commune. */}
